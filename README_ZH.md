...
- **远征装备表** (Expedition loadout sheets) — 规划模块，尚未实现。
- **资源优先级清单** (Resource priority lists) — 规划模块，尚未实现。
- **撤离复盘日志** (Extraction review journal) — 规划模块，尚未实现。
