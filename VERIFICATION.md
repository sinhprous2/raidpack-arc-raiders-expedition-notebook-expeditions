# Verification plan — ARC Raiders

Status: NOT RUN. There is no executable implementation to test.

## Module acceptance criteria

### 1. Expedition loadout sheets

- [ ] Define a versioned input fixture specifically for expedition loadout sheets.
...
### 2. Resource priority lists

- [ ] Define a versioned input fixture specifically for resource priority lists.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.

### 3. Extraction review journal

- [ ] Define a versioned input fixture specifically for extraction review journal.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.
