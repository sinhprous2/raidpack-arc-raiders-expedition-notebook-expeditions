...
<div align="center">
  <img src="./public/logo.svg" alt="RaidPack — ARC Raiders — Expeditions" width="64" height="64">
  <h1>RaidPack — ARC Raiders — Expeditions</h1>
</div>

An independent project specification for ARC Raiders, covering expedition loadout sheets, resource priority lists, extraction review journal.
...
<img src="./public/screenshots/desktop-main.svg" alt="ARC Raiders — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="ARC Raiders — compact concept, not a screenshot" width="250">
<br>
...
- **Expedition loadout sheets** — planned module; not implemented.
- **Resource priority lists** — planned module; not implemented.
- **Extraction review journal** — planned module; not implemented.

The proposed workflow separates expedition loadout sheets from resource priority lists, with extraction review journal retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Expedition loadout sheets**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="RaidPack — ARC Raiders — Expeditions — specification review workflow">
<br>
...
### Expedition loadout sheets

Define the input and expected outcome for module 1. Record the ARC Raiders version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Resource priority lists

Define the input and expected outcome for module 2. Record the ARC Raiders version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Extraction review journal

Define the input and expected outcome for module 3. Record the ARC Raiders version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Expedition loadout sheets |
